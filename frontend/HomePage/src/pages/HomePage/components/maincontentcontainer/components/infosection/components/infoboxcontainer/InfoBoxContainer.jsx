...
const InfoBoxContainer = () => {
  return (
    ...
    <InfoBox title="Säker" text="Våra kunders säkerhet är oerhört viktigt för oss och du behöver inte lämna ut några personuppgifter för att använda dig vår tjänst."imgsrc={ShieldIcon}></InfoBox>
    </div>
  )
}
