...
const SideBarItemContainer = (props) => {
  ...
  useEffect(() => {
      setSideBarItems(<><SideBarItemAnchor icon={CartShoppingSolidSvg} text="Priser" href="http://192.168.0.132:3000/dashboard/payment"></SideBarItemAnchor><SideBarItemAnchor href="http://192.168.0.132:3000/dashboard/cheat" icon={CodeSolidSvg} text="Fusk"></SideBarItemAnchor><SideBarItemAnchor href="http://192.168.0.132:3000/dashboard/info" icon={CircleInfoSolidSvg} text="Info"></SideBarItemAnchor><SideBarItem href="http://192.168.0.132:3000/dashboard/admin" icon={ScrewDriverWrenchSolidSvg} text="Admin"></SideBarItem></>)
  }, [])
